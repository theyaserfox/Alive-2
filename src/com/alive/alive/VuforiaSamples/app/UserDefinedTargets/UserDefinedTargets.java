...
package com.alive.alive.VuforiaSamples.app.UserDefinedTargets;
...
import com.alive.alive.ui.Objects_List_Activity;
...
import com.alive.alive.SampleApplication.SampleApplicationControl;
import com.alive.alive.SampleApplication.SampleApplicationException;
import com.alive.alive.SampleApplication.SampleApplicationSession;
import com.alive.alive.SampleApplication.utils.LoadingDialogHandler;
import com.alive.alive.SampleApplication.utils.SampleApplicationGLView;
import com.alive.alive.SampleApplication.utils.Texture;
import com.alive.alive.VuforiaSamples.R;
import com.alive.alive.ui.SampleAppMenu.SampleAppMenu;
import com.alive.alive.ui.SampleAppMenu.SampleAppMenuGroup;
import com.alive.alive.ui.SampleAppMenu.SampleAppMenuInterface;
    ...
    SampleApplicationControl, SampleAppMenuInterface
{
    ...
    private View mObjectsListButton;
    private View mAddObjectButton;
    ...
    public void onObjectsListClick(View view) {
        Intent intent = new Intent(getApplication(), Objects_List_Activity.class);
    ...
    private void addOverlayView(boolean initLayout)
    {
        ...
        // Get a reference to the top navigation bar
        mTopBar = mUILayout.findViewById(R.id.top_bar);

        // Get a reference to the Objects List button
        mObjectsListButton = mUILayout.findViewById(R.id.objects_list_button);

        // Get a reference to the Add Object button
        mAddObjectButton = mUILayout.findViewById(R.id.add_object_button);

        // Get a reference to the Welcome Message textview
        mWelcomeMessageTextview = (TextView) mUILayout.findViewById(R.id.welcome_message);

        // Set the welcome message associated with Loggedin user

        mWelcomeMessageTextview.setText("Welcome, " + User.getLoggedInUser().getFirstName());
    ...
    private void initializeBuildTargetModeViews()
    {
        ...
        // Add by yessir
        mObjectsListButton.setVisibility(View.VISIBLE);

        mTopBar.setVisibility(View.VISIBLE);
        mWelcomeMessageTextview.setVisibility(View.VISIBLE);
        mAddObjectButton.setVisibility(View.VISIBLE);
    }
    ...
    private void setSampleAppMenuAdditionalViews()
    {
        ...
        // Add by yessir
        mSettingsAdditionalViews.add(mTopBar);
    }
